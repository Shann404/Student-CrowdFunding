            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                {featuredCampaigns.map((campaign, index) => (
                  <div 
                    key={campaign._id}
                    className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl overflow-hidden border border-gray-100 hover:border-blue-200/50 transition-all duration-500 hover:scale-105"
                  >
                    {/* Campaign Image */}
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-4">
                        <div className="flex justify-between text-sm mb-2">
                          <span className="text-gray-600">Raised: ${campaign.currentAmount?.toLocaleString() || '0'}</span>
                          <span className="text-gray-600">Goal: ${campaign.targetAmount?.toLocaleString() || '0'}</span>
                        </div>
                      ...
                      <Link
                        ...
                        className="block w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white text-center py-3 rounded-xl hover:from-blue-600 hover:to-purple-600 transform hover:scale-105 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
                      >
                        Support This Dream
                      </Link>
                    </div>
